...
const StyledButton = styled.button<{ hoverEffect: boolean }>`
    ...
    &:hover,
    &.active {
        background: ${({ hoverEffect }) => (hoverEffect ? "rgb(235, 236, 239)" : "")};
    }
`;
...
function LeftBar({ tool, setTool, setIsReset }: Props) {
    ...
    return (
        <StyledWrap>
            <div>
                <Tool text="선택하기 V">
                    <StyledButton hoverEffect={true} onClick={() => setTool("select")} className={tool === "select" ? "active" : undefined}>
                ...
                <Tool text="이동하기 M">
                    <StyledButton hoverEffect={true} onClick={() => setTool("move")} className={tool === "move" ? "active" : undefined}>
                        <svg width="24" height="24" fill="#50555A" xmlns="http://www.w3.org/2000/svg" fillOpacity="1" viewBox="0 0 96 96">
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                ...
                <StyledLine />
                <Tool text="바운딩 박스 B">
                    <StyledButton hoverEffect={true} onClick={() => setTool("bounding")} className={tool === "bounding" ? "active" : undefined}>
                        <svg width="24" height="24" fill="#50555A" xmlns="http://www.w3.org/2000/svg" fillOpacity="1" viewBox="0 0 96 96">
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
